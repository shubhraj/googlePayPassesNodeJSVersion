...
class Services {
    ...
    async getClassAndObjectDefinitions(verticalType, classId, objectId, classResourcePayload, objectResourcePayload) {
        if (verticalType === "VerticalType.OFFER") {
            classResourcePayload =  resourceDefinitions.makeOfferClassResource(classId); //done till here...
            objectResourcePayload = resourceDefinitions.makeOfferObjectResource(classId, objectId); // work from here...
        }
